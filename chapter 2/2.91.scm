...
;One small detail is that you can't have div-poly return both quotient and remainder.Because the implementation of div-terms uses
;The generic function div.To install div-poly into a generic function, div-terms handles the case of recursive coeff nesting.
;Div-poly also needs to return only one quotient, according to the original definition of div.
;To do this, we split the division correlation operation into three functions
;* div-poly, returns the quotient.
;* rem-poly, returns the remainder.
;* div-rem-poly, returns both quotient and remainder.
