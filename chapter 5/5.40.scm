...
;;Mainly modifies compile-lambda-body to extend the compile-time environment.The compile process also adds the env parameter, which is passed along.
...
;;Primarily here, you need to extend the compile-time environment
