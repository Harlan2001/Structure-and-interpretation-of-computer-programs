...
Refer to [Exercise 4.5](../chapter 4/4.5.md) 中的 b), we started by implementing cond as Scheme code
...
This is then manually translated into an evaluator instruction
