...
We implement cond and let and let* syntax. Among them

* [exercise 4.6](../chapter_4/4.6.md) has implemented `let->combination`。
* [exercise 4.7](../chapter_4/4.7.md) has implemented `let*->nested-lets`。

These can serve as the basic procedures for the evaluator.Modified based on [ch5-eceval.scm](./ch5-eceval.scm).Registration basis process
...
`eval-dispatch` tag added in machine instruction
